...
namespace ChessChallenge.Application
{
    public class BoardUI
    {
        ...
        {
            ulong bitboard = currentBitboard;
        ...
        public void VisualizeBitboard(ulong bitboard){
            currentBitboard = bitboard;
            isShowBitboard = true;
        }

        public void StopVisualizingBitboard(){
            isShowBitboard = false;
        }
    }
}